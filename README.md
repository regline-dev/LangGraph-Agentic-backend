...
**다음:** **3차 순번 0** — `/pdf/vector` 일반·비ARKK 1건 H · 계획 `Docs/20260723_3차_PDF_입력단메타_이력DB_중복_계획.md`  
...
| H | [ ] | 8 | **(선택)** 생성 PDF → `data/uploads` → ingest 한 버튼 → **3차 여유(순번 7)로 이관** |

### 3차 · 입력단 메타 · 이력 DB · 중복 · 후속
순번은 **이 섹션만 1부터**. 상세: `Docs/20260723_3차_PDF_입력단메타_이력DB_중복_계획.md`
...
현재: **1차** 완료 · **2차** MVP 본체 완료 (5 Vercel H·8 선택은 잔여/3차 여유) · **다음 = 3차-0 게이트(일반·비ARKK 벡터 H)** → 1 DB → 2~3 §12 → 4~5 입력단 메타
